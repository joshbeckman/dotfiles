...
- **Contacts** combine identity claims, addressable scratchpads, and participants in Josh’s mail history. A fresh heartbeat with a live PID is labeled “active (heartbeat)”, not guaranteed availability. Historical, unaddressable contacts remain listed but cannot be selected for delivery.
